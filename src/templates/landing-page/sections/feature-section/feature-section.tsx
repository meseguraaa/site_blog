      ...
      <div className="col-span-full flex flex-col gap-2">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-4 rounded-lg bg-gray-500 p-6 md:p-12">
          <div className="flex flex-col gap-4">
            ...
            <Button className="w-fit gap-2 rounded-full hidden mt-4 md:mt-auto md:flex" asChild>
          ...
          <div className="flex flex-col items-center justify-center w-full">
            <div className="w-full max-w-md overflow-hidden">
              <Image className="object-cover w-full" src="/feature_section.svg" alt="Features" width={440} height={330} />
            </div>
