    ...
    <section className="relative pb-8 md:py-10 bg-gray-700">
      ...
      <div className="container relative">
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-3">
          ...
          <div className="flex h-full flex-col gap-2 rounded-lg p-6 md:p-12 bg-blue-400">
          ...
          <div className="flex h-full flex-col gap-2 rounded-lg p-6 md:p-12 bg-cyan-300">
          ...
          <div className="flex h-full flex-col gap-2 rounded-lg p-6 md:p-12 bg-blue-400">
            ...
            <p className="text-body-sm text-gray-200">
              Nossa equipe estará sempre pronta para te ajudar no que for preciso.
            </p>
          </div>
        </div>
      </div>
